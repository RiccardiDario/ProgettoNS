...
iptables -A FORWARD -i eth1 -o eth0 -p udp -d 172.1.3.5 --dport 5060 -j NFLOG --nflog-prefix="Rule number: 19" 
iptables -A FORWARD -i eth1 -o eth0 -p udp -d 172.1.3.5 --dport 5060 -j ACCEPT

# Droppo tutto il resto del traffico UDP
iptables -A FORWARD -i eth1 -o eth0 -p udp -j NFLOG --nflog-prefix="Rule number: 20"
iptables -A FORWARD -i eth1 -o eth0 -p udp -j DROP

# Droppo tentativi di connessione rete estrena ->rete interna
iptables -A FORWARD -d 172.1.1.0/24 -j NFLOG --nflog-prefix="Rule number: 21"
...
iptables -A FORWARD -s 172.1.1.0/24  -i eth1  -j NFLOG --nflog-prefix="Rule number: 22"
...
iptables -A FORWARD -i eth1 -o eth0 -m state --state NEW,ESTABLISHED,RELATED -j NFLOG --nflog-prefix="Rule number: 23"	                     
iptables -A FORWARD -i eth1 -o eth0 -m state --state NEW,ESTABLISHED,RELATED -j ACCEPT

iptables -A FORWARD -i eth0 -o eth1 -m state --state ESTABLISHED,RELATED -j NFLOG --nflog-prefix="Rule number: 24"
