...
##############################################################################################################################
iptables -P INPUT -j NFLOG --nflog-prefix="Rule number: 1 "
iptables -P INPUT ACCEPT

iptables -P OUTPUT -j NFLOG --nflog-prefix="Rule number: 2"
iptables -P OUTPUT ACCEPT

iptables -P FORWARD -j NFLOG --nflog-prefix="Rule number: 3 "
iptables -P FORWARD ACCEPT

# Elimino pacchetti non validi 
iptables -A INPUT -m state --state INVALID -j NFLOG --nflog-prefix="Rule number: 4 "
iptables -A INPUT -m state --state INVALID -j DROP

iptables -A OUTPUT  -m state --state INVALID -j NFLOG --nflog-prefix="Rule number: 5"
iptables -A OUTPUT  -m state --state INVALID -j DROP

iptables -A FORWARD -m state --state INVALID -j NFLOG --nflog-prefix="Rule number: 6 "
iptables -A FORWARD -m state --state INVALID -j DROP

# Droppo pacchetti frammentati
iptables -A FORWARD -f -j NFLOG --nflog-prefix="Rule number: 7"
iptables -A FORWARD -f -j DROP				

# Droppo pacchetti no-sense	
iptables -A FORWARD -p tcp --tcp-flags ALL ACK,RST,SYN,FIN -j NFLOG --nflog-prefix="Rule number: 8"												
iptables -A FORWARD -p tcp --tcp-flags ALL ACK,RST,SYN,FIN -j DROP	

iptables -A FORWARD -p tcp --tcp-flags ALL ALL -j NFLOG --nflog-prefix="Rule number: 9"	
iptables -A FORWARD -p tcp --tcp-flags ALL ALL -j DROP

iptables -A FORWARD -p tcp --tcp-flags ALL NONE -j NFLOG --nflog-prefix="Rule number: 10"
iptables -A FORWARD -p tcp --tcp-flags ALL NONE -j DROP

iptables -A FORWARD -p tcp --tcp-flags SYN,FIN SYN,FIN -j NFLOG --nflog-prefix="Rule number: 11"
iptables -A FORWARD -p tcp --tcp-flags SYN,FIN SYN,FIN -j DROP

iptables -A FORWARD -p tcp --tcp-flags SYN,RST SYN,RST -j NFLOG --nflog-prefix="Rule number: 12"
...
iptables -A PING_OF_DEATH -p icmp --icmp-type echo-request -m limit --limit 1/s -j NFLOG --nflog-prefix="Rule number: 13"
...
iptables -A PING_OF_DEATH -p icmp --icmp-type echo-request -j NFLOG --nflog-prefix="Rule number: 14"
...
iptables -A SYN_FLOOD -m limit --limit 1/s -j NFLOG --nflog-prefix="Rule number: 15"
iptables -A SYN_FLOOD -m limit --limit 1/s -j RETURN
# Se non ha un match con la regola precedente il pacchetto viene scartato
iptables -A SYN_FLOOD -j NFLOG --nflog-prefix="Rule number: 16"
...
iptables -A UDP_FLOOD -p udp -m limit --limit 1/s -j NFLOG --nflog-prefix="Rule number: 17"
iptables -A UDP_FLOOD -p udp -m limit --limit 1/s -j RETURN

iptables -A UDP_FLOOD -j NFLOG --nflog-prefix="Rule number: 18"
iptables -A UDP_FLOOD -j DROP

# Accetto tutto il traffico diretto alla porta 53 protocollo udp
iptables -A FORWARD -i eth1 -o eth0 -p udp -d 172.1.3.4 --dport 53 -j NFLOG --nflog-prefix="Rule number: 19"
...
iptables -A FORWARD -i eth1 -o eth0 -p udp -d 172.1.3.5 --dport 5060 -j NFLOG --nflog-prefix="Rule number: 20" 
iptables -A FORWARD -i eth1 -o eth0 -p udp -d 172.1.3.5 --dport 5060 -j ACCEPT

# Droppo tutto il resto del traffico UDP
iptables -A FORWARD -i eth1 -o eth0 -p udp -j NFLOG --nflog-prefix="Rule number: 21"
iptables -A FORWARD -i eth1 -o eth0 -p udp -j DROP

# Droppo tentativi di connessione rete interna ->rete esterna
iptables -A FORWARD -d 172.1.2.0/24 -j NFLOG --nflog-prefix="Rule number: 22"
...
iptables -A FORWARD -s 172.1.2.0/24  -i eth1  -j NFLOG --nflog-prefix="Rule number: 23"
iptables -A FORWARD -s 172.1.2.0/24  -i eth1  -j DROP

# Droppo tutti i tentativi di connessione su tcp provenienti dalla DMZ 
iptables -A FORWARD -p tcp -s 172.1.3.0/24 --syn -j NFLOG --nflog-prefix="Rule number: 24"
...
iptables -A FORWARD -i eth1 -o eth0 -m state --state NEW,ESTABLISHED,RELATED -j NFLOG --nflog-prefix="Rule number: 25"	                     
iptables -A FORWARD -i eth1 -o eth0 -m state --state NEW,ESTABLISHED,RELATED -j ACCEPT

iptables -A FORWARD -i eth0 -o eth1 -m state --state ESTABLISHED,RELATED -j NFLOG --nflog-prefix="Rule number: 26"
